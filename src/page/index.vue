<template>
  <div class="container">
    ...
    >
      ...
      <NFormItem path="year" label="年">
        ...
        <NInput
          ...
          :disabled="!form.yearEdit"
          style="width: 85px"
        />
        <NSelect
          v-model:value="form.yearValue"
          :options="state.yearData"
          @update:value="
            (e) => {
              form.year = e;
            }
      ...
      <NFormItem path="week" label="周">
        ...
        <NInput
          ...
          :disabled="!form.weekEdit"
          style="width: 85px"
        />
        <NSelect
          v-model:value="form.weekValue"
          :options="state.weekData"
          @update:value="
            (e) => {
              form.week = e;
            }
    ...
    <div class="toolbox">
      <NButton type="primary" class="ml-10px" id="add-barcode" @click="getBarCode"
        >生成条码</NButton
      >
      <NButton type="primary" class="ml-10px" id="add-qrcode" @click="selectPrinter"
        >选择打印机</NButton
      >
      <NButton type="primary" class="ml-10px" id="add-qrcode" @click="printLabel"
        >打印</NButton
      >
      <NButton type="primary" class="ml-10px" @click="handleOpenFile"
        >打开 Excel 文件</NButton
      >
    </div>
  </div>
